...
import com.example.tugbes.models.Cart;
import com.example.tugbes.prevalent.prevalent;
import com.example.tugbes.viewholder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTotalAmount = (TextView)findViewById(R.id.total_harga);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull final Cart cart) {
                ...
                int oneTypeProductPrice=(Integer.parseInt(cart.getPrice().replaceAll("\\D+",""))) * Integer.parseInt(cart.getQuantity());
            ...
            public CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_items_layouts, parent, false);
