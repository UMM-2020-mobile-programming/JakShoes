...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void StoreProductInformation() {
        ...
        loading.setTitle("Menambahkan Produk");
        loading.setMessage("Silahkan tunggu, menambahkan produk baru...");
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "Mengambil url gambar produk berhasil...", Toast.LENGTH_SHORT).show();
